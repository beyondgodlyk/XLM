...
from xlm.data.loader import check_data_params, load_data, load_binarized, set_dico_parameters
...
def get_parser():
    ...
    parser.add_argument("--lambda_bt", type=str, default="1",
                        help="BT coefficient")
    parser.add_argument("--lambda_tst", type=str, default="1",
                        help="TST coefficient")
    ...
    parser.add_argument("--finetuning", type=bool_flag, default=True,
                        help="Fine-tuning of DAE with Sentiment classifier using lowercased mixed EN and 4SQ FR dataset")
    # Datasets for EN
...
def main(params):
    ...
    tst_data = load_tst_data(params, logger)
    ...
    if params.encoder_only:
        ...
        classifier = Classifier(params.emb_dim,
                                params.kernel_sizes,
                                params.dropout,
                                params.fc_sizes,
                                params.num_filters).cuda()
